  ...
  <div id="main-slider" class="main-carousel carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="placeholders/slide1.jpg" alt="">
        <div class="carousel-caption">
          <div class="formatted-sm formatted-sm-2nd">
            <h1>Featured Benefits</h1>
      ...
      <div class="item">
        <img src="placeholders/slide2.jpg" alt="">
        <div class="carousel-caption">
          <div class="formatted-sm formatted-sm-2nd">
            <h1>Types of System</h1>
            <a href="#" class="btn btn-default">Read More</a>
